...
namespace applause
{
    ...
    /**
     * @class GUIExtension
     * @brief CLAP GUI extension that manages editor lifecycle and host communication.
     * 
     * This extension provides a framework-agnostic way to integrate GUI editors
     * with CLAP hosts.
     *
     * The extension doesn't actually implement a GUI; rather, it is a C++ glue layer
     * that lets generic UI editors communicate with the host application and respond to parameter changes.
     *
     * To implement your own GUI system, override and implement IEditor.h. Of course, we recommend the built-in
     * GPU-accelerated ApplauseEditor, which makes building a GUI with parameter integration quick and easy.
     */
    ...
    public:
        ...
        /**
         * @brief Construct a GUI extension using your plugin's supplied editor factory lambda.
         * 
         * @param host The CLAP host
         * @param factory Function that creates editor instances
         * @param defaultWidth Default editor width in pixels. It is recommended to use a height and width that correspond to a nice integer aspect ratio (e.g. 16:9, 4:3, etc)
         * @param defaultHeight Default editor height in pixels. It is recommended to use a height and width that correspond to a nice integer aspect ratio (e.g. 16:9, 4:3, etc)
         * @param fixedAspectRatio Whether to maintain aspect ratio on resize. //TODO Add auto UI scaling when this is true
         */
        explicit GUIExtension(const clap_host_t* host, 
