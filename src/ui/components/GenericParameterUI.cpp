...
GenericParameterEntry::GenericParameterEntry(ParamInfo& paramInfo) : paramInfo_(paramInfo)
{
...
GenericParameterUI::GenericParameterUI()
{
    ...
    scrollableLayout().setFlexItemAlignment(visage::Layout::ItemAlignment::Stretch);  // Children stretch to fill width
}
