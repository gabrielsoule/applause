 ...
 * @brief A plug-and-play editor that automatically displays all parameters using GenericParameterUI.
 * 
 * This editor provides a simple solution for displaying all plugin parameters without
 * requiring custom UI implementation. It automatically populates a GenericParameterUI
 * with all non-internal parameters from the provided ParamsExtension.
 * 
 * The editor size is configured through the GUIExtension factory, and the GenericParameterUI
 * automatically fills the window with appropriate padding.
 */
