...
namespace applause
{
     ...
     *
     * That said, we enthusiastically recommend our bespoke Applause::ApplauseEditor!
     */
    class IEditor
    {
    public:
         ...
         *
         * If you don't care about parameters, or have your own parameters extension that bypasses
         * ParamsExtension entirely, you can return a nullptr here.
         *
